...
@Slf4j
@Service
public class SubjectDetailClient {
	
	@Autowired
    private WebClient client;
	
    
    @Value("${spring.subjectClient.url}")
    ...
    public SubjectDetailClient(WebClient.Builder builder) {
        
    	this.client = builder.baseUrl(lookupClientURL).build();
    }

    public Mono<BatchInfoDTO> getSubjectDtls(){
